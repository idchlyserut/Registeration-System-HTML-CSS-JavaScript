...
<?php include "php/filesLogic.php" ?>
	...
	<?php 
		if(isset($_POST['sendmail'])) {
			...
			$mail->setFrom(EMAIL, 'Acceptance Email For Internship Applicants!');
			...
			$mail->Body    = '<div style="border:2px solid red;">Congratulation! You are accepted to JPKN!<b>in bold!</b></div>
								<p> We are very delighted to inform that you are accepted to JPKN! Please reply us if you are still interested </p>';
