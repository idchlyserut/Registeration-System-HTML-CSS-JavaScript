      ...
      <nav class="main-nav float-right d-none d-lg-block">
        <ul>
          ...
          <li><a href="result.php">Result List</a></li>
            <li><a href="login_admin.php?logout='1'">Log Out</a></li>
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                      <?php foreach ($files as $file): ?>
                                        ...
                                        <button type="submit" name="decline" class="btn btn-warning btn-sm " >Decline</button>
                                        </td>
                                        <td>
                                        <button type="submit" name="delete" class="btn btn-danger btn-sm" >X</button>
