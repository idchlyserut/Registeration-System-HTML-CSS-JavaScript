					...
					<h1 class="h3 mb-3 font-weight-normal">Sign up</h1>
                            ...
                            <div>
							 ...
							 <div>
                                ...
                                <input type="number" min="20" name="period" id="period" class="form-control" placeholder="Internship Weeks (min 20 weeks)" required />
                            </div>
                            <div>
                            ...
                            <div class="form-group form-button">
                                <button type="submit" name="submit" id="signup" class="btn btn-lg btn-primary btn-block"  value="Register"/>Sign Up</button>
                            </div>
